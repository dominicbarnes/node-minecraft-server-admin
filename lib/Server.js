...
function Server(dir) {
    ...
    this.banned = {
        ips:     new File.ListFile(this.file("server/banned-ips.txt")),
        players: new File.ListFile(this.file("server/banned-players.txt"))
    };
...
Object.defineProperty(Server.prototype, "status", {
    get: function () {
        return this.game ? this.game.status : "Stopped";
    }
});
...
Server.prototype.del = function (callback) {
    ...
    if (this.game) {
        ...
        wrench.rmdirRecursive(this.dir, function (err) {
...
Server.prototype.banned = function (callback) {
    var server = this;
...
Server.prototype.setJar = function (jar, callback) {
    var src = jar, dest = this.jar;
